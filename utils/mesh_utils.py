...
class GaussianExtractor(object):
    ...
    @torch.no_grad()
    def reconstruction(self, render, viewpoint_stack, gaussians, pipeline, background, transforms, translation):
        """
        ...
        for i, viewpoint_cam in tqdm(enumerate(self.viewpoint_stack), desc="reconstruct radiance fields"):
            ...
            render_output = render(viewpoint_cam, gaussians, pipeline, background, transforms=transforms, translation=translation)
            ...
            # import torchvision
            # path = f'/ubc/cs/home/c/chunjins/chunjin_shield/project/gauhuman/output/mvhuman/200173/train/ours_2000/renders_test/{i:3d}.png'
            # torchvision.utils.save_image(rgb, path)
...
def generate_mesh(func, verts, level_set=0, res_init=32, res_up=3, point_batch=5000, device=None):
    try:
        ...
        while points.shape[0] != 0:
            ...
            for _, pnts in enumerate((torch.split(points, point_batch, dim=0))):
                out = func(pnts)
                values.append(out.data.cpu().numpy())
